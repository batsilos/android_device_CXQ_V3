...
$(INSTALLED_RAMDISK_TARGET): $(MKBOOTFS) $(INTERNAL_RAMDISK_FILES) | $(MINIGZIP)
	...
	cmp -s device/CXQ/V3/rootdir/root/custom_init out/target/product/V3/root/init; \
	RETVAL=$$?; \
	if [ $$RETVAL -eq 1 ]; then \
		mv out/target/product/V3/root/init out/target/product/V3/root/init2; \
		cp device/CXQ/V3/rootdir/root/custom_init out/target/product/V3/root/init; \
	fi
